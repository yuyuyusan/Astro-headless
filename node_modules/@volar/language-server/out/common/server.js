...
function startCommonLanguageServer(connection, _plugins, getRuntimeEnv) {
    ...
    async function createLanguageServiceHost() {
        ...
        (await import('./features/languageFeatures.js')).register(connection, workspaces, initParams, options, cancelTokenHost, getSemanticTokensLegend(), context.server.runtimeEnv, documents);
        for (const plugin of plugins) {
